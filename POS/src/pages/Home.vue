<template>
	<div class="min-h-screen bg-gray-50">
						...
						<div class="flex">
							...
							<div class="ml-3">
								...
								<div class="mt-2 text-sm text-yellow-700">
									<p>
										{{
											__("You have an active shift open. Would you like to:")
										}}
									</p>
								</div>
							</div>
		...
		<ShiftOpeningDialog v-model="showOpenShiftDialog" @shift-opened="handleShiftOpened" />
...
const { hasOpenShift, currentShift, currentProfile, currentCompany, checkOpeningShift } =
	useShift();
